                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2">
                    {isAlreadyIssued ? (
                      ...
                      >
                        <i className="fas fa-check-circle mr-2"></i> Already
                        Issued
                      </button>
                    ) : (
                      <Link
                        to={`/issued?bookId=${book.id}`}
                        className={`flex-1 flex items-center justify-center py-2.5 rounded-lg text-sm font-medium transition-all shadow-sm ${book.available > 0 ? "bg-secondary hover:bg-[#00a38d] text-white cursor-pointer" : "bg-bg-light text-text-muted border border-border-color cursor-not-allowed pointer-events-none"}`}
                      >
                        {book.available > 0 ? "Issue" : "Out of Stock"}
                      </Link>
                    )}
