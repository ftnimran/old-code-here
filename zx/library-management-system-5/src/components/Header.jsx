...
export default function Header() {
  ...
  return (
    // Changed md:left-[260px] to lg:left-[260px]
    <nav className="h-[70px] glass fixed top-0 right-0 left-0 lg:left-[260px] z-40 flex items-center justify-between px-4 sm:px-8 shadow-sm transition-all duration-300">
      {/* Left side: Hamburger (Mobile/Tablet Only) + Search */}
      ...
      <div className="flex items-center gap-3 sm:gap-6">
        ...
        <button
          ...
          className="text-text-muted hover:text-warning p-2 rounded-full hover:bg-black/5 w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center"
        >
          <i
