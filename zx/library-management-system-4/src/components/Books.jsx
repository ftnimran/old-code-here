              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 bg-secondary hover:bg-[#00a38d] text-white flex items-center justify-center py-2.5 rounded-lg text-sm font-medium transition-all shadow-sm"
                  >
                    Issue
                  </Link>
                  {isAdmin && (
