...
export default function Members() {
  ...
  const handleSubmit = (e) => {
    ...
    if (editingId) {
      ...
      addNotification(
        "Profile Updated",
        `Your account details were modified by Admin.`,
        "info",
        "fa-user-pen",
        formData.email,
      );
      addNotification(
        "Member Updated",
        `Successfully updated ${formData.name}'s profile.`,
        "success",
        "fa-check",
        "admin",
      );

      showAlert("Updated successfully!", "Success", "success");
    } else {
      const exists = usersList.find(
      ...
      addNotification(
        "Account Created",
        `Welcome to LibMaster! Your account has been activated.`,
        "success",
        "fa-user-plus",
        formData.email,
      );
  ...
  const handleDelete = (id, email, name) => {
    showConfirm(
      ...
      () => {
        ...
        // This will now correctly push the delete notification to the Admin
        addNotification(
          "Member Deleted",
                  ...
                  >
                    ...
                    <td className="p-4 whitespace-nowrap">
                      <div className="flex gap-2">
                        ...
                        <button
                          // Passing the member's name securely here
                          onClick={() =>
